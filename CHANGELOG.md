...
- Zenodo DOI badge in the README and `doi` field in `CITATION.cff`.

## [0.5.2]

### Fixed

- Broken intra-doc link to `griffinlim` in `spectral` docs (`cargo doc -D warnings` now passes).

### Added

- `CITATION.cff` for software citation and Zenodo DOI archiving.
